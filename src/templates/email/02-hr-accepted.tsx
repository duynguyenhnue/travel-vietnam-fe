...
const HRAcceptedEmailTemplate: any = (props: EmailTemplateType) => {
  ...
  return (
    <div>
      ...
      <p style={{ marginLeft: '20px', textAlign: 'left' }}>
        <br />
        <span style={{ color: 'rgb(29, 28, 29)', fontFamily: 'Slack-Lato, Slack-Fractions, appleLogo, sans-serif', fontStyle: 'normal', fontVariantLigatures: 'common-ligatures', fontVariantCaps: 'normal', fontWeight: 400, letterSpacing: 'normal', orphans: 2, textAlign: 'left', textIndent: 0, textTransform: 'none', widows: 2, wordSpacing: 0, WebkitTextStrokeWidth: 0, whiteSpace: 'normal', textDecorationThickness: 'initial', textDecorationStyle: 'initial', textDecorationColor: 'initial', float: 'none', display: 'inline !important', fontSize: '15px' }}>
          We are pleased to offer you the position of {candidate?.role} at STARACK. This is a fulltime position with a start date of {candidate?.onboardDate}.
        </span>
        <br />
        <span style={{ color: 'rgb(29, 28, 29)', fontFamily: 'Slack-Lato, Slack-Fractions, appleLogo, sans-serif', fontStyle: 'normal', fontVariantLigatures: 'common-ligatures', fontVariantCaps: 'normal', fontWeight: 400, letterSpacing: 'normal', orphans: 2, textAlign: 'left', textIndent: 0, textTransform: 'none', widows: 2, wordSpacing: 0, WebkitTextStrokeWidth: 0, whiteSpace: 'normal', textDecorationThickness: 'initial', textDecorationStyle: 'initial', textDecorationColor: 'initial', float: 'none', display: 'inline !important', fontSize: '15px' }}>
          We were impressed with your skills and experience, and believe you would be a valuable addition to our team. Please find attached a more detailed offer letter outlining the terms of your employment.
        </span>
        <br />
        <span style={{ color: 'rgb(29, 28, 29)', fontFamily: 'Slack-Lato, Slack-Fractions, appleLogo, sans-serif', fontStyle: 'normal', fontVariantLigatures: 'common-ligatures', fontVariantCaps: 'normal', fontWeight: 400, letterSpacing: 'normal', orphans: 2, textAlign: 'left', textIndent: 0, textTransform: 'none', widows: 2, wordSpacing: 0, WebkitTextStrokeWidth: 0, whiteSpace: 'normal', textDecorationThickness: 'initial', textDecorationStyle: 'initial', textDecorationColor: 'initial', float: 'none', display: 'inline !important', fontSize: '15px' }}>
          To accept this offer, please sign and return the offer letter by {getExpireTimeToReplyEmail(2)}.  We look forward to welcoming you aboard!
        </span>
      </p>
      <p style={{ marginLeft: '20px', textAlign: 'left' }}>
        <br />

...
const HRApplicationReceivedEmailTemplate = (props: EmailTemplateType) => {
  ...
  return (
    <div>
      ...
      <p style={{ marginLeft: '20px', textAlign: 'left' }}>
        ...
        >
          Thank you for your application for the {candidate?.role} position at STARACK. We
        ...
        >
          Our hiring team is currently reviewing all applications. We will be contacting candidates
          selected for interviews within the next two weeks. If you are not contacted by then, we
          encourage you to continue exploring other opportunities.
        </span>
        <br />
        <span
          style={{
...
export default HRApplicationReceivedEmailTemplate;

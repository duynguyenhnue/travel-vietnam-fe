...
const HRRejectedEmailTemplate = (props: EmailTemplateType) => {
  ...
  return (
    <div>
      ...
      <p style={{ marginLeft: '20px', textAlign: 'left' }}>
        ...
        >
          Thank you for your interest in the {candidate?.role} position at STARACK. We appreciated
        ...
        >
          While we were impressed with your qualifications, we have decided to move forward with
          other candidates whose experience more closely aligns with the requirements of this role.
        </span>
        <br />
        <span
          style={{

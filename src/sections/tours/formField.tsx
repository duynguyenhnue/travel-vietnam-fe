...
import { Box, TextField, MenuItem, FormControl, Menu, IconButton, Typography, Container, Grid, Popover } from '@mui/material';
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                    <FormControl fullWidth sx={{ mb: 2 }}>
                        ...
                        >
                            <Box p={2} sx={{width: '100%', ".rdrCalendarWrapper, .rdrMonth": {width: "100%"}}}>
                                <DateRange
                                    ranges={[bookedDates]}
                ...
                <Grid item xs={12} sm={6}>
                    <FormControl fullWidth sx={{ mb: 2 }}>
                        <TextField
                            ...
                            variant="outlined"
                            value={`${t(tokens.tours.adults)}: ${adults}${children !== 0 ? `, ${t(tokens.tours.children)}: ${children}` : ''}`}
                            onClick={handleClick}
                            fullWidth
                            InputProps={{
                                readOnly: true,
